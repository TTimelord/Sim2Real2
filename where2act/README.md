...
1. We migrated where2act to sapien2. 
2. Modified the point cloud normalization method.
3. etc

# Original readme of Where2Act: From Pixels to Actions for Articulated 3D Objects
