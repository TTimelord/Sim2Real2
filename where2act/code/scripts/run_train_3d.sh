python train_3d.py \
    ...
    --sample_succ \
    --pretrained_critic_ckpt /home/rvsa/where2act_ws/where2act/code/logs/exp-model_3d_critic-pushing-left-Faucet-faucet_8_critic_train-val=48000-9600_off-on=500-1/ckpts/9-network.pth \
    --epochs 100 \
    --overwrite \
