python train_3d.py \
    ...
    --sample_succ \
    --pretrained_critic_ckpt /home/rvsa/where2act_ws/where2act/code/logs/exp-model_3d_critic-pushing-Laptop-laptop_7_critic_train-val=7000-1400_off-on=90-1/ckpts/30-network.pth \
    --epochs 100 \
    --overwrite \
