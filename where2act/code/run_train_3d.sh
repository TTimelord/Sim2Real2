python train_3d.py \
    --exp_suffix drawer_35_all_train-val=77000-14000_off-on=100-1 \
    ...
    --sample_succ \
    --pretrained_critic_ckpt ./logs/exp-model_3d_critic-pushing-Drawer-drawer_35_critic_train-val=77000-14000_off-on=100-1/ckpts/139-network.pth \
    --epochs 140 \
    --overwrite \
    --no_visu \
