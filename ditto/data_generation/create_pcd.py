...
if __name__ == '__main__':
    ...
    parser.add_argument('--debug', action='store_true', default=False, help='visual monitor debug [default: False]')
    args = parser.parse_args()

    pcd_path = f"real_test/real_datasets/{args.category.lower()}/video_{args.cnt_id}"
    ...
    # setup env
    env = Env(show_gui=(not args.no_gui), object_position_offset=0.5)
