...
# load data
root_path = os.getcwd()
category = 'drawer_ablation'
# model_id='ablation_no_inter'
realdata_path = os.path.join(root_path,'real_test/real_datasets',category)
model_ids = os.listdir(realdata_path)
for model_id in tqdm(model_ids):
    if not model_id == 'ablation_3':
        continue
    target_qpos = 0.2
    ...
    src_pcd = downsample_points(pcd_1, 0.002, 50, 0.1)
    dst_pcd = downsample_points(pcd_2, 0.002, 50, 0.1)
    ...
    # ckpt = torch.load('/home/rvsa/where2act_ws/Ditto/logs/runs/2022-09-15/all_stereo_ablation-18-08-53/checkpoints/last.ckpt') # all stereo ablation
