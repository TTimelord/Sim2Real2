...
ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/sapien_newdrawer_different_state_nobounding/model/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/sapien_newdrawer_addbounding/model/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/different_state_sapien_drawer/model/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/singleview_laptop_unseen/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/stereo_depth_laptop_unseen/model/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/openangle_laptop_stereo_depth/model/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/stereo_laptop_frontview/model/checkpoints/epoch211.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/box/model/checkpoints/epoch53.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/drawer/model(0.26)/checkpoints/last.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/faucet/model/checkpoints/epoch51.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/stapler/model/checkpoints/epoch58.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/laptop/model/checkpoints/epoch101.ckpt')
# ckpt = torch.load('/home/xulab10/Ditto/logs/results_mj/laptop/laptop_new/sapien-14-25-25/checkpoints/last.ckpt')
