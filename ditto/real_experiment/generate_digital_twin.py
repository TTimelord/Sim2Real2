...
# load data
# root_path = os.getcwd()
root_path = "/home/guest2/Documents/Sim2Real2/ditto"
...
ROTATE = category in ['drawer', 'faucet']  # True for drawer and faucet
if ROTATE:
    R = np.array([[-1, 0, 0],
                  [0, -1, 0],
                  [0, 0, 1]])
...
#         args="/home/guest2/Documents/Sim2Real2/ditto/real_test/./TestVHACD " + str(
#             os.path.join(urdf_path, "mesh_0.obj")), shell=True)
#     os.rename("/home/guest2/Documents/Sim2Real2/ditto/decomp.obj", f"/home/guest2/Documents/Sim2Real2/ditto/real_test/real_datasets/{category}/video_{args.cnt}/digital_twin/mesh_0_decomp.obj")
#     completed = subprocess.run(
#         ["/home/guest2/Documents/Sim2Real2/ditto/real_test/./TestVHACD " + str(os.path.join(urdf_path, "mesh_1.obj"))],
#         shell=True)
#     os.rename("/home/guest2/Documents/Sim2Real2/ditto/decomp.obj", f"/home/guest2/Documents/Sim2Real2/ditto/real_test/real_datasets/{category}/video_{args.cnt}/digital_twin/mesh_1_decomp.obj")
#
# except:
