...
class GeoArtDatasetTestAblation(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pc_end, pc_end_idx = sample_point_cloud(data["pc_start"], self.num_point)
        ...
        # state_end = np.array(data["state_start"]*1.0001, dtype=np.float32)
        ...
        # if "sapien" in self.path_list[index]:
