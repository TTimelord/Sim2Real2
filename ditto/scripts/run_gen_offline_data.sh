# python data_generation/gen_offline_data.py \
...
#   --ins_cnt_fn assets/stats/ins_cnt_faucet.txt \
 ...
 python data_generation/gen_offline_data.py \
   --data_dir data/laptop/train/scenes \
   --stereo_data_dir data/laptop_stereo/train/scenes \
   --data_fn assets/stats/laptop_train.txt \
   --category_types Laptop \
   --num_processes 16 \
   --ins_cnt_fn assets/stats/ins_cnt_laptop.txt \

 python data_generation/gen_offline_data.py \
   --data_dir data/laptop/val/scenes \
   --stereo_data_dir data/laptop_stereo/val/scenes \
   --data_fn assets/stats/laptop_val.txt \
   --category_types Laptop \
   --num_processes 16 \
   --ins_cnt_fn assets/stats/ins_cnt_laptop.txt \