...
class ArmImpEEPosKpController(ArmImpEEPosController):
    ...
    def simulation_step(self):
        ...
        return super(ArmImpEEPosKpController, self).simulation_step()
...
class ArmImpEEPosKpKdController(ArmImpEEPosController):
    ...
    def set_action(self, action: np.ndarray):
        ...
        self.target_ee_kp = action[6:12]
        self.target_ee_kd = action[12:18]
    ...
    def simulation_step(self):
        ...
        return super(ArmImpEEPosKpKdController, self).simulation_step()
